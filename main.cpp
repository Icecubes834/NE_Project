...
enemy::enemy(){
	...
	cout <<"The random number is: "<<firstRandomHexDigit;
	if (firstRandomHexDigit > 9){
		if(firstRandomHexDigit == 10) hexData[0] = 'A';
		if(firstRandomHexDigit == 11) hexData[0] = 'B';
		if(firstRandomHexDigit == 12) hexData[0] = 'C';
		if(firstRandomHexDigit == 13) hexData[0] = 'D';
		if(firstRandomHexDigit == 14) hexData[0] = 'E';
		if(firstRandomHexDigit == 15) hexData[0] = 'F';
	}
	cout << "Hex number"<<hexData;
}
